import type { OmniFieldIR, OmniProjectIR, OmniServiceIR } from "@omnirpc/core";
import { validateProjectIR } from "@omnirpc/core";
...
export function compileContracts(services: any[], name = "omnirpc-app", version = "0.1.0"): OmniProjectIR {
